// Based on this C11 grammar: https://www.quut.com/c/ANSI-C-grammar-y.html

// Note that this grammar is not used to automatically generate parser code.
// It's purposes is only to document the grammar.
