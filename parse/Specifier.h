...
enum Specifier: SpecifierSet {
    ...
    QUALIFIER_TRANSITORY = token_to_specifier(TOK_TRANSITORY),
...
constexpr QualifierSet SPECIFIER_MASK_QUALIFIER = QUALIFIER_CONST | QUALIFIER_RESTRICT | QUALIFIER_VOLATILE | QUALIFIER_TRANSITORY;
