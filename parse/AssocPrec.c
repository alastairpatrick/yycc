...
const AssocPrec g_assoc_prec[TOK_NUM] = {
    ...
    [TOK_EQ_OP]         = { LEFT_ASSOCIATIVE, EQUALITY_PRECEDENCE, OP_BOOL_RESULT },
    [TOK_NE_OP]         = { LEFT_ASSOCIATIVE, EQUALITY_PRECEDENCE, OP_BOOL_RESULT },

    ['<']               = { LEFT_ASSOCIATIVE, RELATIONAL_PRECEDENCE, OP_BOOL_RESULT },
    ['>']               = { LEFT_ASSOCIATIVE, RELATIONAL_PRECEDENCE, OP_BOOL_RESULT },
    [TOK_LE_OP]         = { LEFT_ASSOCIATIVE, RELATIONAL_PRECEDENCE, OP_BOOL_RESULT },
    [TOK_GE_OP]         = { LEFT_ASSOCIATIVE, RELATIONAL_PRECEDENCE, OP_BOOL_RESULT },
